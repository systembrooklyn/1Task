...
class Task extends Model
{
    ...
    protected $with = ['mainTaskAttachments'];
    ...
    {
        return $this->hasMany(TaskAttachment::class)->where('is_main', false);
    }
    public function mainTaskAttachments()
    {
        return $this->hasMany(TaskAttachment::class)->where('is_main', true);
    }
